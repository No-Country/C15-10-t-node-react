      ...
      <div className="flex flex-col h-auto lg:flex-row justify-center bg-green-600 text-2xl items-center lg:px-32 px-5 gap-12 mb-10">
        ...
        <div className="space-y-2 lg:pt-16 mt-0">
          ...
          <form id='form' className='flex flex-col gap-1' onSubmit={handleSubmit}>
            ...
            <input className="border-2 border-green-500 rounded-md" type="text" name="firstname" placeholder=' Nombre' />
            <p className="text-sm text-black font-bold">Apellido</p>
            <input className="border-2 border-green-500 rounded-md" type="text" name="lastname" placeholder=' Apellido' />
            <p className="text-sm text-black font-bold">Email</p>
            <input className="border-2 border-green-500 rounded-md" type="email" name="email" placeholder=' Email' />
            <p className="text-sm text-black font-bold">Contraseña</p>
            <input className="border-2 border-green-500 rounded-md" type="password" name="password" placeholder=' Contraseña' />
            <p className="text-sm text-black font-bold">Repetir contraseña</p>
            <input className="border-2 border-green-500 rounded-md" type="password" name="repeatPassword" placeholder=' Repetir contraseña' />
            <button className='btn mx-auto text-sm font-bold border-2 border-black bg-black px-20 py-2 mt-2 mb-0 rounded-full text-white hover:text-black'>Registrarse</button>
          </form>
